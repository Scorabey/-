...
- [x] Необов'язкові властивості
- [x] Readonly властивості
- [x] Array type
---
...
#### **Нотатки:**
##### Readonly property
> Readonly властивості можна прочитати, но не можна змінювати
...
```typescript
function House(house: Array<number>) {
	console.log(house.length)
}

let myArray = [12.5, 14.5, 14.7]

House(myArray)
```

#### **Нотатки:**
> Також в JS існують такі типи як: Map, Promise, [більше про типи...](https://www.typescriptlang.org/docs/handbook/2/objects.html#the-array-type)
