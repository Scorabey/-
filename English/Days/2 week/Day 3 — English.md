...
| 🎯 Статус              | В процесі  |
| 📅 Початок             | 2026-05-15 |
| 🔁 Наступне повторення | 2026-05-15 |
| ⏱️ Годин витрачено     | 1          |
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 395     | В процесі |

### 📦 Нові слова цього тижня

| Слово    | Транскрипція | Переклад | Приклад речення                        |
| -------- | ------------ | -------- | -------------------------------------- |
| Terrible | [ˈter.ə.bəl] | Жахливо  | I didn`t like chese, her very terrible |
| Vest     | [vɛst]       | Жилет    | Soldiers wear armor vest               |
| Rainy    | [ˈreɪni]     | Дощова   | On the outside rainy weather           |

### 💪 Streak та статистика

- **Поточний streak:** 6 днів
- **Максимальний streak:** 6 днів
- **Всього вивчено слів:** 395
...
```
Правило: Однина будь якого іменника — 's
Приклади:
	Tom's toy
	The cat's tail

Правило: Множина, що вже закінчується на -s — s'
Приклади:
	The students' books
	The parents' car

Правило: Множина без -s — додай 's
Приклади:
	Children's toys
	Women's team

Правило: Для людей / тварин — 's. Для нежевих речей -of
Приклади:
	Tom's car
	The end of the film
```
...
| ----------- | --- | ------- | -------- | ----- | --------- |
| Castelvania |     | English | English  | 3     | Завершено |

### 📺 Журнал перегляду

| Дата       | Назва       | Епізод | Нові слова | Нові фрази | Час (хв) |
| ---------- | ----------- | ------ | ---------- | ---------- | -------- |
| 15.05.2026 | Castelvania | 3      |            |            | 28       |
...
_Шаблон створено: 2026-05-15 | Оновлено: 2026-05-15_