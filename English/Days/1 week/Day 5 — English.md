...
|🎯 Статус|В процесі|
|📅 Початок|2026-05-10|
|🔁 Наступне повторення|2026-05-10|
|⏱️ Годин витрачено|0|
...
| ------------------------ | ---- | ------- | --------- |
| 1000 Basic English Words | 1000 | 0       | В процесі |

### 📦 Нові слова цього тижня

| Слово | Транскрипція | Переклад | Приклад речення       |
| ----- | ------------ | -------- | --------------------- |
| Above | [əˈbʌv]      | Вище     | Airplane above to car |

### 💪 Streak та статистика

- **Поточний streak:** 1 днів
- **Максимальний streak:** 4 днів
- **Всього вивчено слів:** 364
- **Слів повторено сьогодні:** 19
...
| ---------- | ------------------------------------- | ------ | ------ |
| 10.05.2026 | Articles: 'a', 'an', 'the'            | A1-A2  | 4      |
| 10.05.2026 | Articles: 'the' or no article         | A1-A2  | 4      |
| 10.05.2026 | Adjectives ending in '-ed' and '-ing' | A1-A2  | 4      |
...
```
Правило: Вживається перед словами, що починаються на приголосний звук
Приклади:
...
```
Правило: Вживається перед словами, що починаються на голосний звук (a, e, i, o, u)
Приклади:
	He ate an apple.
...
```
Правило: Вживається, коли предмет конкретний або вже відомий
Приклади:
	Close the door, please.
	I bought a book. The book was great.
...
| ----------- | --- | ------- | -------- | ----- | --------- |
| Castelvania |     | English | EN/UA    | 8     | Завершено |

### 📺 Журнал перегляду

| Дата       | Назва       | Епізод | Нові слова | Нові фрази | Час (хв) |
| ---------- | ----------- | ------ | ---------- | ---------- | -------- |
| 10.05.2026 | Castelvania | 8      |            |            | 25       |
...
## 💡 Поради та інсайти
Article The: `the USA` — не тому що "єдина", а тому що скорочення від _the United States_, де артикль граматично прив'язаний до слова _States_.
---
...
_Шаблон створено: 2026-05-10 | Оновлено: 2026-05-10_